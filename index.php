...
<body>
    ...
    <ul>
        <li><a id='wszystko' href="index.php?kategoriajs=a">Wszystko</a></li>
        <li><a id='biblioteki' href="index.php?kategoriajs=b">Biblioteki</a></li>
        <li><a id='plywalnie' href="index.php?kategoriajs=p">Pływalnie</a></li>
        <li><a id='rozrywka'href="index.php?kategoriajs=r">Rozrywka</a></li>
        <li><a id='inne'href="index.php?kategoriajs=i">Inne</a></li>
    ...
    <div class="grid-container">
        ...
        <div class="flex-container1">
            <?php 
                $obiekty = array(array('b', 'Biblioteka na Koszykowej'), array('b', 'Biblioteka Narodowa'), 
